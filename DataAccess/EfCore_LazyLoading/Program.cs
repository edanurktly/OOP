using EfCore_LazyLoading.Entities;
...
namespace EfCore_LazyLoading
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /*
             Lazy (Tembel) Loading (Yükleme): Navigation property'leri uzerinde bir islem yaptigimizda ilgili navigation propertye karsi gelen sorgunun olusturulup execute edilmesi ve yuklenmesini saglayan yaklasimdir.
            Bunun icin Microsoft.EntityFramaworkCore.Proxies paketini yuklenmesi gerekmektedir.
            Sonrasinda DbContext nesnemizde OnConfiguring() metodunda .UseLazyLoadingProxies() eklenmesi gerekir.
